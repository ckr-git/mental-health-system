  ...
  <el-container class="layout-container">
    ...
    <el-aside v-if="!isMobile" width="240px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router class="sidebar-menu">
        ...
        <el-menu-item index="/doctor/crisis-alerts"><div class="menu-icon">🚨</div><span>危机告警</span></el-menu-item>
        ...
        <el-menu-item index="/doctor/scheduling"><div class="menu-icon">🗓️</div><span>排班设置</span></el-menu-item>
        <el-menu-item index="/doctor/treatment-plans"><div class="menu-icon">📝</div><span>治疗计划</span></el-menu-item>
