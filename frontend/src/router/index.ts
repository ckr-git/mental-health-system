    ...
    // 患者端路由
    {
      ...
      children: [
        ...
        },
        {
          path: 'assessments',
          name: 'Assessments',
          component: () => import('@/views/patient/Assessments.vue')
        },
        {
          path: 'meditation',
          name: 'Meditation',
          component: () => import('@/views/patient/Meditation.vue')
        },
        {
          path: 'doctors',
          name: 'Doctors',
    ...
    // 医生端路由
    {
      ...
      children: [
        ...
        },
        {
          path: 'crisis-alerts',
          name: 'CrisisAlerts',
          component: () => import('@/views/doctor/CrisisAlerts.vue')
        },
        {
          path: 'scheduling',
        ...
        },
        {
          ...
          name: 'DoctorTreatmentPlans',
          component: () => import('@/views/doctor/TreatmentPlans.vue')
        }
      ]
    },
    // 管理员端路由
